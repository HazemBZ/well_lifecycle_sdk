...
const WellTrajectorySurveyVisualization = () => {
  ...
  const [calculationMethod, setCalculationMethod] = useState("minimumCurvature");
  ...
  // Mock data for wells
  const wells = [
    { value: "well1", label: "Well Alpha-1", icon: "CircleDot" },
    { value: "well2", label: "Well Beta-2", icon: "CircleDot" },
    { value: "well3", label: "Well Gamma-3", icon: "CircleDot" },
    { value: "well4", label: "Well Delta-4", icon: "CircleDot" },
  ];
  
  // Mock data for calculation methods
  const calculationMethods = [
    { value: "minimumCurvature", label: "Minimum Curvature" },
    { value: "radiusOfCurvature", label: "Radius of Curvature" },
    { value: "tangential", label: "Tangential" },
    { value: "balanced", label: "Balanced Tangential" },
    { value: "averageAngle", label: "Average Angle" },
  ];
  
  // Mock data for color options
  const colorOptions = [
    { value: "formation", label: "Formation" },
    { value: "phase", label: "Drilling Phase" },
    { value: "dogleg", label: "Dogleg Severity" },
  ...
  const handleRemoveWell = (wellToRemove) => {
    setSelectedWells(selectedWells.filter(well => well.value !== wellToRemove.value));
        ...
        <div className="flex-1 overflow-auto">
          ...
          <div className="bg-white border-b border-neutral-200 px-6 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-neutral-900">Well Trajectory & Survey Visualization</h1>
                <p className="mt-1 text-sm text-neutral-600">
                  Visualize and analyze wellbore paths based on deviation survey data
                </p>
              </div>
              ...
              <nav className="-mb-px flex space-x-6">
                <button
                  className={`pb-3 px-1 border-b-2 font-medium text-sm ${
                    activeTab === "3d" ?"border-primary-600 text-primary-600" :"border-transparent text-neutral-500 hover:text-neutral-700 hover:border-neutral-300"
                  }`}
                ...
                <button
                  className={`pb-3 px-1 border-b-2 font-medium text-sm ${
                    activeTab === "2d" ?"border-primary-600 text-primary-600" :"border-transparent text-neutral-500 hover:text-neutral-700 hover:border-neutral-300"
                  }`}
                ...
                <button
                  className={`pb-3 px-1 border-b-2 font-medium text-sm ${
                    activeTab === "data" ?"border-primary-600 text-primary-600" :"border-transparent text-neutral-500 hover:text-neutral-700 hover:border-neutral-300"
                  }`}
                ...
                <button
                  className={`pb-3 px-1 border-b-2 font-medium text-sm ${
                    activeTab === "settings" ?"border-primary-600 text-primary-600" :"border-transparent text-neutral-500 hover:text-neutral-700 hover:border-neutral-300"
                  }`}
            ...
            <div className="flex flex-wrap gap-3">
              <div className="w-48">
                <Dropdown
                  ...
                  value={colorOptions.find(option => option.value === colorBy)}
              ...
              <div className="flex items-center">
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  <span className="ml-2 text-sm font-medium text-neutral-700">Show Uncertainty</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            {activeTab === "3d" && (
              <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-neutral-200 flex justify-between items-center">
                  <h2 className="text-lg font-medium text-neutral-900">3D Wellbore Trajectory</h2>
                  <ToolBar />
                </div>
            ...
            {activeTab === "2d" && (
              <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-neutral-200 flex justify-between items-center">
                  <h2 className="text-lg font-medium text-neutral-900">2D Section Views</h2>
                  <ToolBar variant="2d" />
                </div>
                <div className="h-[calc(100vh-320px)] min-h-[500px]">
                  <Visualization2D 
            ...
            {activeTab === "data" && (
              <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-neutral-200 flex justify-between items-center">
                  <h2 className="text-lg font-medium text-neutral-900">Survey Data Grid</h2>
            ...
            {activeTab === "settings" && (
              <div className="bg-white rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="p-4 border-b border-neutral-200">
                  <h2 className="text-lg font-medium text-neutral-900">Calculation Settings</h2>
                </div>
                <div className="p-6">
                  <CalculationSettings 
                    calculationMethod={calculationMethod}
      ...
      {isImportModalOpen && (
        <div className="fixed inset-0 bg-neutral-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4">
            <div className="p-4 border-b border-neutral-200 flex justify-between items-center">
              <h2 className="text-lg font-medium text-neutral-900">Import Survey Data</h2>
              <button
      ...
      {isExportModalOpen && (
        <div className="fixed inset-0 bg-neutral-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="p-4 border-b border-neutral-200 flex justify-between items-center">
              <h2 className="text-lg font-medium text-neutral-900">Export Trajectory Data</h2>
              <button
                className="text-neutral-500 hover:text-neutral-700"
                onClick={toggleExportModal}
              >
                    ...
                    <div className="block">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300"
                        />
                        <span className="ml-2 text-sm text-neutral-700">Excel</span>
                      </label>
                    </div>
                    <div className="block">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300"
                        />
                        <span className="ml-2 text-sm text-neutral-700">WITSML</span>
                      </label>
                    </div>
                    <div className="block">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300"
                        />
                        <span className="ml-2 text-sm text-neutral-700">PDF Report</span>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    <label className="inline-flex items-center">
                      <input
                        ...
                        defaultChecked
                      />
                      <span className="ml-2 text-sm text-neutral-700">Raw Survey Data</span>
                    </label>
                    <div className="block">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          defaultChecked
                        />
                        <span className="ml-2 text-sm text-neutral-700">Calculated Points</span>
                      </label>
                    </div>
                    <div className="block">
                      <label className="inline-flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300 rounded"
                        />
                        <span className="ml-2 text-sm text-neutral-700">Include Visualizations</span>
                      </label>
                    </div>
                  </div>
                </div>
