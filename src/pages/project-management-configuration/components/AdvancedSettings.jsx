      ...
      <div className="space-y-8">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
          <div className="px-6 py-4 border-b border-neutral-200">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Set the default units of measurement for this project.
            </p>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
          <div className="px-6 py-4 border-b border-neutral-200">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Configure reference data and coordinate systems.
            </p>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
          <div className="px-6 py-4 border-b border-neutral-200">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Configure data retention policies for this project.
            </p>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
          <div className="px-6 py-4 border-b border-neutral-200">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Configure access control and sharing settings.
            </p>
          </div>
          <div className="p-6">
            <div className="space-y-6">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden shadow-sm">
          <div className="px-6 py-4 border-b border-neutral-200">
            ...
            <p className="mt-1 text-sm text-neutral-500">
              Add custom fields to capture additional project metadata.
            </p>
          </div>
          <div className="p-6">
            <div className="space-y-6">
