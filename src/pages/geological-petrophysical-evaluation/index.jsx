...
const GeologicalPetrophysicalEvaluation = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "visualization":
        return (
          <LogVisualization depthUnit={depthUnit} depthRange={depthRange} />
        );
      case "core":
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
          <div>
            ...
            <p className="text-neutral-600">
              Integrate core data, formation tops, and petrophysical
              calculations for comprehensive interpretation
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex space-x-4">
              <Input
                ...
                onChange={(e) =>
                  handleDepthRangeChange("min", parseFloat(e.target.value))
                }
                min={0}
                className="flex-1"
              />
              <Input
                ...
                onChange={(e) =>
                  handleDepthRangeChange("max", parseFloat(e.target.value))
                }
                min={depthRange.min}
                className="flex-1"
              />
            ...
            <Dropdown
              ...
              value={{
                value: depthUnit,
                label: depthUnit === "m" ? "Meters (m)" : "Feet (ft)",
              }}
