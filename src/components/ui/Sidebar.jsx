...
const Sidebar = ({
  ...
  const getContextualItems = () => {
    ...
    if (path.includes("well-log-viewer")) {
      return [
        ...
        },
        {
          ...
          path: "/well-log-viewer-analysis/tracks",
          icon: "Sliders",
        },
        {
          name: "Curve Management",
          path: "/well-log-viewer-analysis/curves",
          icon: "Activity",
        },
        {
          name: "Depth Reference",
          path: "/well-log-viewer-analysis/depth",
          icon: "ArrowDownUp",
        },
        {
          name: "Annotations",
          path: "/well-log-viewer-analysis/annotations",
          icon: "Edit3",
        },
        {
          name: "Export",
          path: "/well-log-viewer-analysis/export",
          icon: "Download",
        },
      ];
    }
    ...
    if (path.includes("drilling-data")) {
      return [
        ...
        {
          name: "Real-time Data",
          path: "/drilling-data-management/realtime",
          icon: "Activity",
        },
        {
          name: "Historical Data",
          path: "/drilling-data-management/historical",
          icon: "Clock",
        },
        {
          name: "Reports",
          path: "/drilling-data-management/reports",
          icon: "FileText",
        },
        {
          name: "Alerts",
          path: "/drilling-data-management/alerts",
          icon: "Bell",
        },
      ];
    }
    ...
    if (path.includes("production-data")) {
      return [
        ...
        },
        {
          ...
          path: "/production-data-analysis/decline",
          icon: "TrendingDown",
        },
        {
          name: "Forecasting",
          path: "/production-data-analysis/forecast",
          icon: "TrendingUp",
        },
        {
          name: "Well Performance",
          path: "/production-data-analysis/performance",
          icon: "Activity",
        },
        {
          name: "Economics",
          path: "/production-data-analysis/economics",
          icon: "DollarSign",
        },
      ];
    }
  ...
  const renderExpandedSidebar = () => {
    const items =
      variant === "contextual" ? getContextualItems() : navigationItems;
